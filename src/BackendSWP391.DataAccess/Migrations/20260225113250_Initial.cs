    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Role__783254B013A98371", x => x.role_name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__UserInfo__B9BE370F86F5446C", x => x.user_id);
                    table.ForeignKey(
                        name: "fk_user_role",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserInfo_role_name",
                table: "UserInfo",
                column: "role_name");

            migrationBuilder.CreateIndex(
                name: "UQ__UserInfo__F3DBC572B414230C",
                table: "UserInfo",
                column: "username",
                unique: true);
        }
